...
def _get_secret_value(secret: SecretType) -> str:
    """
    Extracts the string value from a secret, whether it is a plain string or a Pydantic SecretStr.
...
def generate_jwt(
    ...
    Args:
        ...
        lifetime_seconds (Optional[int], optional): Token lifetime in seconds. If provided, sets the 'exp' claim. Defaults to None.
        algorithm (str, optional): The algorithm to use for encoding. Defaults to 'HS256'.
...
def decode_jwt(
    ...
    Args:
        ...
        algorithms (list[str], optional): List of acceptable algorithms. Defaults to ['HS256'].
